...
(function(root, factory) {
  ...
  describe('Input', function() {
    it('should create an instance of Input', function() {
      ...
      //var instane = new ocr.Input();
      //expect(instance).to.be.a(ocr.Input);
    });
    ...
    it('should have the property skew (base name: "skew")', function() {
      // uncomment below and update the code to test the property skew
      //var instane = new ocr.Input();
      //expect(instance).to.be();
    });
