...
(function(root, factory) {
  ...
  describe('OCRSettings', function() {
    it('should create an instance of OCRSettings', function() {
      // uncomment below and update the code to test OCRSettings
      //var instane = new ocr.OCRSettings();
      //expect(instance).to.be.a(ocr.OCRSettings);
    });
    ...
    it('should have the property regionSettings (base name: "regionSettings")', function() {
      // uncomment below and update the code to test the property regionSettings
      //var instane = new ocr.OCRSettings();
      //expect(instance).to.be();
    });
