...
(function(root, factory) {
  ...
  describe('OCRJob', function() {
    it('should create an instance of OCRJob', function() {
      // uncomment below and update the code to test OCRJob
      //var instane = new ocr.OCRJob();
      //expect(instance).to.be.a(ocr.OCRJob);
    });
