...
(function(root, factory) {
  ...
  describe('OCRTask', function() {
    it('should create an instance of OCRTask', function() {
      // uncomment below and update the code to test OCRTask
      //var instane = new ocr.OCRTask();
      //expect(instance).to.be.a(ocr.OCRTask);
    });
