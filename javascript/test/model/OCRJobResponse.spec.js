...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ocr.OCRJobResponse();
  });
  ...
  describe('OCRJobResponse', function() {
    it('should create an instance of OCRJobResponse', function() {
      // uncomment below and update the code to test OCRJobResponse
      //var instane = new ocr.OCRJobResponse();
      //expect(instance).to.be.a(ocr.OCRJobResponse);
    });
