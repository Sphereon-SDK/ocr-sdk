...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ocr.OCRResultResponse();
  });
  ...
  describe('OCRResultResponse', function() {
    it('should create an instance of OCRResultResponse', function() {
      // uncomment below and update the code to test OCRResultResponse
      //var instane = new ocr.OCRResultResponse();
      //expect(instance).to.be.a(ocr.OCRResultResponse);
    });
