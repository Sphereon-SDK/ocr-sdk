...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ocr.RegionSettings();
  });
  ...
  describe('RegionSettings', function() {
    it('should create an instance of RegionSettings', function() {
      // uncomment below and update the code to test RegionSettings
      //var instane = new ocr.RegionSettings();
      //expect(instance).to.be.a(ocr.RegionSettings);
    });

    it('should have the property resultModes (base name: "resultModes")', function() {
      // uncomment below and update the code to test the property resultModes
      //var instane = new ocr.RegionSettings();
