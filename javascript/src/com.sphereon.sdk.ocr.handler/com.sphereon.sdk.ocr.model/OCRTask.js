...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ocr.OCRTask = factory(root.ocr.ApiClient);
  }
  ...
  /**
   * The OCRTask model module.
   * @module com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/OCRTask
   * @version 0.3.2
   */

  /**
   * Constructs a new <code>OCRTask</code>.
   * OCR Task
   * @alias module:com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/OCRTask
   * @class
   */
  ...
  /**
   * Constructs a <code>OCRTask</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/OCRTask} obj Optional instance to populate.
   * @return {module:com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/OCRTask} The populated <code>OCRTask</code> instance.
   */
   ...
   * @member {module:com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/OCRTask.EngineEnum} engine
   */
   ...
   * @member {module:com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/OCRTask.StatusEnum} status
   */
