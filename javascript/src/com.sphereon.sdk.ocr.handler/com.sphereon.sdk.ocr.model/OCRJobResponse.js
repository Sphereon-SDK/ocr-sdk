...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['com.sphereon.sdk.ocr.handler/ApiClient', 'com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/OCRJob', 'com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/OCRTask'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./OCRJob'), require('./OCRTask'));
  } else {
    // Browser globals (root is window)
    if (!root.ocr) {
      root.ocr = {};
    }
    root.ocr.OCRJobResponse = factory(root.ocr.ApiClient, root.ocr.OCRJob, root.ocr.OCRTask);
  }
}(this, function(ApiClient, OCRJob, OCRTask) {
  'use strict';
  ...
  /**
   * The OCRJobResponse model module.
   * @module com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/OCRJobResponse
   * @version 0.3.2
   */

  /**
   * Constructs a new <code>OCRJobResponse</code>.
   * The OCR job. Has access to the job settings as well as ocr engine tasks
   * @alias module:com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/OCRJobResponse
   * @class
   * @param inputs {Array.<String>} The original input files. Currently supported inputs are: tiffs
   * @param status {module:com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/OCRJobResponse.StatusEnum} The status of the job
   */
  ...
  /**
   * Constructs a <code>OCRJobResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/OCRJobResponse} obj Optional instance to populate.
   * @return {module:com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/OCRJobResponse} The populated <code>OCRJobResponse</code> instance.
   */
   ...
   * @member {module:com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/OCRJobResponse.StatusEnum} status
   */
