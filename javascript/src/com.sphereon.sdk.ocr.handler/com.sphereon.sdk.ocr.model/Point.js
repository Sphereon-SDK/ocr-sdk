...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ocr.Point = factory(root.ocr.ApiClient);
  }
   ...
   * @module com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/Point
   * @version 0.3.2
   */
   ...
   * point
   * @alias module:com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/Point
   * @class
   ...
   * @param {module:com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/Point} obj Optional instance to populate.
   * @return {module:com.sphereon.sdk.ocr.handler/com.sphereon.sdk.ocr.model/Point} The populated <code>Point</code> instance.
   */
