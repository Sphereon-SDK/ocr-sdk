...
public class Input   {
  ...
  @SerializedName("skew")
  private Double skew = null;

  public Input rotation(Double rotation) {
   ...
   * @return rotation
  **/
  @ApiModelProperty(example = "null", required = true, value = "rotation of the inputdocument")
  ...
  public Input width(Double width) {
    this.width = width;
    return this;
  }
   ...
   * @return width
  **/
  @ApiModelProperty(example = "null", required = true, value = "width of the inputdocument")
  ...
  public Input height(Double height) {
    this.height = height;
    return this;
  }
   ...
   * @return height
  **/
  @ApiModelProperty(example = "null", required = true, value = "height of the inputdocument")
   ...
   * @return skew
  **/
  @ApiModelProperty(example = "null", required = true, value = "skew of the inputdocument")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Input input = (Input) o;
    return Objects.equals(this.rotation, input.rotation) &&
        Objects.equals(this.width, input.width) &&
        Objects.equals(this.height, input.height) &&
        Objects.equals(this.skew, input.skew);
  }

  @Override
  public int hashCode() {
    return Objects.hash(rotation, width, height, skew);
  }
