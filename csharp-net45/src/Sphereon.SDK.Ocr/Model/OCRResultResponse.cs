...
namespace Sphereon.SDK.Ocr.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OCRResultResponse :  IEquatable<OCRResultResponse>
    {
        /// <summary>
        ...
        public OCRResultResponse(string JobId = null, OCRResult OcrResult = null, List<OcrTask> Ocrtasks = null, List<string> Inputs = null, OCRJob Job = null)
        {
            // to ensure "Inputs" is required (not null)
            if (Inputs == null)
            {
                throw new InvalidDataException("Inputs is a required property for OCRResultResponse and cannot be null");
            }
            else
            {
                this.Inputs = Inputs;
