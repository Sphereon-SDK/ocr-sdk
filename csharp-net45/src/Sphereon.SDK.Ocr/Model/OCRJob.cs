...
namespace Sphereon.SDK.Ocr.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OCRJob :  IEquatable<OCRJob>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OCRJob" /> class.
        /// </summary>
        ...
        public OCRJob(string JobId = null, OCRSettings Settings = null)
        {
            // to ensure "JobId" is required (not null)
            if (JobId == null)
            {
                throw new InvalidDataException("JobId is a required property for OCRJob and cannot be null");
            }
            else
            {
                this.JobId = JobId;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as OCRJob);
        }

        /// <summary>
        /// Returns true if OCRJob instances are equal
        /// </summary>
        /// <param name="other">Instance of OCRJob to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OCRJob other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
