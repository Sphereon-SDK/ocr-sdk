...
namespace Sphereon.SDK.Ocr.Model
{
    ...
    public partial class Word :  IEquatable<Word>
    {
        ...
        public Word(int? Top = null, int? Left = null, int? Bottom = null, int? Right = null, string Text = null, Region Region = null)
        {
            // to ensure "Text" is required (not null)
            if (Text == null)
            {
                throw new InvalidDataException("Text is a required property for Word and cannot be null");
            }
            else
            {
                this.Text = Text;
            ...
            if (Region == null)
            {
                throw new InvalidDataException("Region is a required property for Word and cannot be null");
            }
            else
            {
                this.Region = Region;
        ...
        /// </summary>
        /// <param name="other">Instance of Word to be compared</param>
        /// <returns>Boolean</returns>
